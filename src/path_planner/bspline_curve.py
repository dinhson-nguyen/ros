...
import path_planner.cubic_spline as cs
...
def main(list_node):
    way_point_x = [item.x for item in list_node]
    way_point_y = [item.y for item in list_node]
    ...
    # plt.plot(rix, riy, color='indigo', label="Interpolated B-Spline path")
    # plt.plot(rx, ry, color='red', label="Cubic Spline Path")
